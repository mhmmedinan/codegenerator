...
@Getter
@Setter
public class NLayerArchGenerateCrudCliCommandSettings extends CrudCliCommandSettings {
    ...
    public Path getEntityPath() {
        return Paths.get(getProjectPath(), "entity", getEntityName() + ".java");
    }
    ...
    public void checkProjectName() {
        ...
        String[] layerFolders = { "service", "entity", "repository", "controller" };
    ...
    public void checkEntityArgument() {
        ...
        File[] entities = new File(Paths.get(getProjectPath(), "entity").toString()).listFiles();
        if (entities == null || entities.length == 0) {
            System.err.println("No entities found in \"" + Paths.get(getProjectPath(), "entity").toString() + "\"");
        }
