...
public class ${entity.name?cap_first}ServiceImpl implements ${entity.name?cap_first}Service {
    ...
    public Get${entity.name?cap_first}Response getById(${entity.idType} id) {
        ...
        Get${entity.name?cap_first}Response response = ${entity.name?cap_first}Mapper.INSTANCE.get${entity.name?cap_first}ResponseFrom${entity.name?cap_first}(${string("camelcase", entity.name)});
        return response;
    }
}
